...
{                    
	 ...
	 * 
	 * @param program 
	 * 			The program a worm may or may not have
	 * 
	...
	/**
	 * Sets the program of the worm to the chosen one
	 * 
	 * @param program
	 * 		The program a worm has been given
	 * 
	 * @post
	 * 		The worm gets a new program
	...
	/**
	 * This method checks whether the worm has a program or not
	 * 
	 * @return
	 * 		true if the program of this worm is not null
